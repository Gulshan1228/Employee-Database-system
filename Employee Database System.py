...
class window1:
    def __init__(self,root):
        ...
        self.root.title("   College Project B.Tech CSE 5th SEMESTER      ---------------     GULSHAN   ANKIT   MOHIT  ")
...
class window2:
    def __init__(self,root):
        ...
        def btn1():
            ...
            tv.heading(5,text="FATHER'S NAME")
        ...
        def btn2():
            class Form:
                ...
                def action(self):
                    ...
                    if n1=="" or con1=="" or em1=="" or gender1=="" or address1=="" or post1=="Select":
                        ...
                        database="project")
                        cur=mydb.cursor()
                        query="insert into info(name,email,contact,gender,father_name,address,post)values(%s,%s,%s,%s,%s,%s,%s);"
                        val=(n1,em1,con1,gender1,father1,address1,post1)
                        try:
